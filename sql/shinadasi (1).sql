...
CREATE TABLE `camera` (
  `カメラID` int(11) NOT NULL,
  `カメラ番号` int(11) NOT NULL,
  `機器名称` varchar(100) NOT NULL
...
(17, 'aaa', '$2y$10$8VltURBElD5AsdPsYglf5OBKVSQZOK2eOrHEniZSrwb3xYhGWo5zO');
...
(20, 'はる', 'ぴっぴ', 444, 444, '444'),
(21, 'pip', 'ぴっぴ', 77777777777, 120, 'human'),
(22, 'takubo', 'ぴっぴ', 7894561230000, 250, '0'),
(23, 'bbb', 'ぴっぴ', 4567891025544, 780, 'human'),
(24, 'ppp', 'ぴっぴ', 756215633, 780, 'human'),
(25, 'mmm', 'ぴっぴ', 756215635, 780, 'human');
...
INSERT INTO `商品詳細` (`商品詳細ID`, `商品ID`, `棚ID`, `商品カテゴリーID`, `在庫数`) VALUES
(2, 23, 1, 1, 0),
(4, 24, 15, 1, 0),
(6, 25, 19, 1, 0);
...
INSERT INTO `基準値` (`基準値ID`, `棚ID`, `商品ID`, `実績`, `時間`) VALUES
(1, 17, 21, '88', '00:00:00'),
(2, 15, 22, '111', '06:06:00');
...
INSERT INTO `履歴` (`履歴ID`, `棚`, `日付`, `最終時間`, `ステータス`) VALUES
(1, '7', '2024-12-03 06:58:15', '23:40:15', '未完了');
...
--
ALTER TABLE `camera`
  ADD PRIMARY KEY (`カメラID`),
  ADD UNIQUE KEY `カメラ番号` (`カメラ番号`),
  ADD UNIQUE KEY `機器名称` (`機器名称`);
...
--
-- テーブルの AUTO_INCREMENT `camera`
--
ALTER TABLE `camera`
  MODIFY `カメラID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ログイン管理`
  MODIFY `管理者ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- テーブルの AUTO_INCREMENT `商品`
--
ALTER TABLE `商品`
  MODIFY `商品ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `商品詳細`
  MODIFY `商品詳細ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- テーブルの AUTO_INCREMENT `基準値`
--
ALTER TABLE `基準値`
  MODIFY `基準値ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- テーブルの AUTO_INCREMENT `履歴`
--
ALTER TABLE `履歴`
  MODIFY `履歴ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- テーブルの AUTO_INCREMENT `棚`
--
ALTER TABLE `棚`
  MODIFY `棚ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
